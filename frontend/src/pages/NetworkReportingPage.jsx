...
const INSIGHT_TONES = {
  success: {
    ...
    labelText: 'text-slate-600 dark:text-emerald-400/80',
    summaryText: 'text-slate-900 dark:text-emerald-100',
    detailText: 'text-slate-700 dark:text-emerald-200/70',
  },
  warning: {
    shell: 'border-amber-500/45 bg-amber-50/80 dark:bg-amber-500/10',
    text: 'text-amber-700 dark:text-amber-300',
    chip: 'bg-amber-100 text-amber-700 dark:bg-amber-500/15 dark:text-amber-300',
    labelText: 'text-slate-600 dark:text-amber-400/80',
    summaryText: 'text-slate-900 dark:text-amber-100',
    detailText: 'text-slate-700 dark:text-amber-200/70',
  },
  info: {
    ...
    labelText: 'text-slate-600 dark:text-blue-400/80',
    summaryText: 'text-slate-900 dark:text-blue-100',
    detailText: 'text-slate-700 dark:text-blue-200/70',
  },
};
