              ...
              <div className="hidden overflow-x-auto md:block">
                <table className="min-w-[940px] w-full text-xs">
                  <thead><tr>
                    ...
                    <SortHeader field="revenue_mom" label="Revenue MoM" active={query.sort_by === 'revenue_mom'} direction={query.sort_dir} onSort={handleSort} />
                    <SortHeader field="payload" label="Payload" active={query.sort_by === 'payload'} direction={query.sort_dir} onSort={handleSort} />
                    <SortHeader field="payload_mom" label="Payload MoM" active={query.sort_by === 'payload_mom'} direction={query.sort_dir} onSort={handleSort} />
